				    ...
				    <table class="table table-bordered">
							...
							<c:forEach  items="${studentList}" var="item">
								<tr>
									...
									<td>${item.stuClass}</td>
									<td>
										<button class="btn btn-default btn-xs btn-info" onClick="location.href='<%=basePath%>/admin/editStudent?id=${item.id}'">修改</button>
										<button class="btn btn-default btn-xs btn-danger btn-primary" onClick="location.href='<%=basePath%>/admin/removeStudent?id=${item.id}'">删除</button>
										<!--弹出框-->
									</td>
								</tr>
							</c:forEach>
