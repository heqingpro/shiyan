			...
			<div class="col-md-10">
				<div class="panel panel-default">
				    <div class="panel-heading">
						<div class="row">
					    	<h1 class="col-md-5">我负责的实验</h1>
							<form class="bs-example bs-example-form col-md-5" role="form" style="margin: 20px 0 10px 0;" action="<%=basePath%>admin/selectCourse" id="form1" method="post">
				    ...
				    <table class="table table-bordered">
							...
							<c:forEach  items="${labList}" var="item">
								<tr>
									...
									<td>${item.outline}</td>
									<td>
										<button class="btn btn-default btn-xs btn-info" onClick="location.href='/teacher/gradeCourse?id=${item.id}'">成绩</button>
										<!--弹出框-->
									</td>
								</tr>
							</c:forEach>
